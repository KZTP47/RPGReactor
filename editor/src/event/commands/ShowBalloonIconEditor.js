...
class ShowBalloonIconEditor {
    ...
    createModal() {
        ...
        container.className = 'show-balloon-icon-container rr-modal';
        container.style.cssText = `width: min(750px, calc(100vw - 24px)); max-height: 92vh;`;
    ...
    renderContent() {
        ...
        header.innerHTML = `
            <div class="rr-modal-title">${tt('Show Balloon Icon')}</div>
